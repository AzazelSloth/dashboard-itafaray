...
#
#  (ou plus simple, avec docker compose — voir README_DOCKER.md)
# =====================================================================

# Base rocker : R + Shiny préinstallés, paquets binaires rapides (Posit PM)
FROM rocker/shiny:4.4.1

# --- Dépendances système ---
#  * librairies de compilation pour les paquets R
#  * pandoc : requis par rmarkdown pour le rapport HTML interactif
...
# --- Paquets R de l'application (shiny est déjà présent dans l'image de base) ---
